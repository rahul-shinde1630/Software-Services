	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<h4 class="logo-text">Software Services</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li>
							<a href="service.php"><i class='bx bx-radio-circle'></i>Manage Services</a>
						</li>

						<li>
							<a href="feature-list.php"><i class='bx bx-radio-circle'></i>Manage Features</a>
						</li>

						<li>
							<a href="pricing-list.php"><i class='bx bx-radio-circle'></i>Pricing Plan</a>
						</li>

						<li>
							<a href="blog-list.php"><i class='bx bx-radio-circle'></i>Blog & Updates</a>
						</li>

						<li>
							<a href="testimonial-list.php"><i class='bx bx-radio-circle'></i>Manage Testimonial</a>
						</li>

						<li>
							<a href="contact-list.php"><i class='bx bx-radio-circle'></i>Contacts</a>
						</li>
						</ul>
