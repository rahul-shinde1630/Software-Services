  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12">
        ...
        <h4 class="mt-5 text-theme">Personal Information</h4>
        <ul class="list-unstyled list-icon">
          <li class="mb-3"> <i class="bi bi-check-lg"></i> Lorem ipsum dolor sit amet, consectetur</li>
          <li class="mb-3"> <i class="bi bi-check-lg"></i> Quidem error quae illo excepturi nostrum blanditiis laboriosam</li>
          <li class="mb-3"> <i class="bi bi-check-lg"></i> Molestias, eum nihil expedita dolorum odio dolorem</li>
          <li class="mb-3"> <i class="bi bi-check-lg"></i> Eum nihil expedita dolorum odio dolorem</li>
          <li> <i class="bi bi-check-lg"></i> Explicabo rem illum magni perferendis</li>
        </ul>
        ...
        <h4 class="mt-5 text-theme">Use of User Information.</h4>
        ...
        <h4 class="mt-5 text-theme">Disclosure of User Information.</h4>
        ...
        <ul class="list-unstyled list-icon">
          <li class="mb-3"> <i class="bi bi-check-lg"></i> Nulla excepturi sint iusto incidunt sed omnis expedita</li>
          <li class="mb-3"> <i class="bi bi-check-lg"></i> Quidem error quae illo excepturi nostrum blanditiis laboriosam</li>
          <li class="mb-3"> <i class="bi bi-check-lg"></i> Deserunt.Lorem ipsum dolor sit amet</li>
          <li> <i class="bi bi-check-lg"></i> Possimus, ex, quisquam. Nulla excepturi</li>
        </ul>
