...
<!-- Mirrored from themeht.com/template/soften/ltr/portfolio-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Jan 2026 15:40:04 GMT -->
<head>
          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <ul class="nav navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link active dropdown-toggle" href="#" data-bs-toggle="dropdown">Pages</a>
                  <ul class="dropdown-menu">
                    <li>
...
<section>
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-12">
        <img class="img-fluid rounded mb-5" src="images/portfolio/large/01.html" alt="">
        <h2>UI/UX Design</h2>
        <p class="mb-5">Big Data Realtime Management Solutions class aptent taciti sociosqu litora torquen conubia nostramase inceptos himenaeo phasellus metus nisl euismod. Vestibulum nec eleifend est, Nulla mattis ante et leo mattis faucis. Quisque aliquam ligula eget sapien sagittis eleifend.</p>
        <h4>Project Description</h4>
        <p>Design your dream website with ease, all completely customized to your needs. We can help you develop and execute a clear and strategic IT roadmap with priorities that are closely linked to business goals. We will work one-on-one with your team to understand your goals.</p>
        <div class="row mt-4">
          <div class="col-md-6">
            <ul class="list-unstyled list-icon">
              <li>
                <i class="bi bi-check-lg"></i>User-Friendly Interface
              </li>
              <li>
                <i class="bi bi-check-lg"></i>Role-based access control
              </li>
              <li>
                <i class="bi bi-check-lg"></i>API access for seamless integration
              </li>
            </ul>
          </div>
          <div class="col-md-6">
            <ul class="list-unstyled list-icon">
              <li>
                <i class="bi bi-check-lg"></i>Advanced reporting and analytics
              </li>
              <li>
                <i class="bi bi-check-lg"></i>Customizable branding options
              </li>
              <li>
                <i class="bi bi-check-lg"></i>Start your journey to success
              </li>
            </ul>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-12 mt-7 mt-lg-0">
        <div class="box-shadow p-5 rounded white-bg">
          <div class="portfolio-meta-list mb-4">
            <div class="portfolio-meta-icon">
              <i class="bi bi-people"></i>
            </div>
            <div class="portfolio-meta-desc">
              <span class="portfolio-meta-title">Created By:</span>
              <span class="portfolio-meta-sub-title">ThemeHt</span>
            </div>
          </div>
          <div class="portfolio-meta-list mb-4">
            <div class="portfolio-meta-icon">
            ...
            <div class="portfolio-meta-desc">
              <span class="portfolio-meta-title">Portfolio Completed:</span>
              <span class="portfolio-meta-sub-title">February 23, 2023</span>
            </div>
          </div>
          <div class="portfolio-meta-list mb-4">
            <div class="portfolio-meta-icon">
            ...
            <div class="portfolio-meta-desc">
              <span class="portfolio-meta-title">Location:</span>
              <span class="portfolio-meta-sub-title">5th Street, 21st Floor, New York, USA</span>
            </div>
          </div>
          <div class="portfolio-meta-list">
            ...
            <div class="portfolio-meta-desc">
              <span class="portfolio-meta-title">Website:</span>
              <span class="portfolio-meta-sub-title">www.themeht.com</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="primary-footer">
      <div class="row">
        ...
        <div class="col-lg-7 col-md-12 mt-5 mt-lg-0">
          <h5>Information</h5>
          <div class="row">
            <div class="col-lg-4 col-md-6 mt-5 mt-md-0 footer-menu">
...
<!-- Mirrored from themeht.com/template/soften/ltr/portfolio-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Jan 2026 15:40:05 GMT -->
</html>